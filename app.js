...
function previewInvoice() {
  ...
  const invoiceNo = 'INV-' + (shop.id || '000') + '-' + (dateVal ? dateVal.replace(/-/g,'') : getTodayString().replace(/-/g,''));
  ...
  div.innerHTML = '<div class="invoice-preview" id="printInvoice">' +
    ...
    '</div></div>' +
    '<button class="btn btn-print" onclick="printInvoice()" style="margin-top:10px;">طباعة الفاتورة</button>';
}
